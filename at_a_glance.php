...
<h2 style="text-align:center">What is CARES</h2>
...
<div id="news">
	...
	<div class="news wide ">
        ...
        <div>
            <h3 style="text-align:center">COMMITTEE OF ACTION FOR RESEARCH, EXTENSION AND SERVICES </h3>
            <table>
            <tr>
   	<td>1.</td> <td>CARES is a non government, non-political, not for profit charitable organization.</td> </tr>
    <tr>
    <td>2.</td> <td>It has been founded by a group of likeminded people representing constituent interests, spearheaded by Dr. A. Majeed Khan, an academic entrepreneur with a background in higher education and agro-based field action research. CARES is a membership organization with four categories of members: Founding, Primary, Institutional and honorary; and also a College of Fellow, who, following a proportional representation constitute the <b>Board of Trustees</b> –the highest authority  that meets once a year. The <b>Board</b> elect/appoints an <b>Executive Committee (EC)</b> for a term of two years that guides and overseas the overall activities of CARES.</td> </tr>
    <tr>
    
    <td>3.</td> <td>The CARES has been visioned as a "virtual" University working together with persons, institutions, organizations and programs to promote and support both basic, applied and prototype research of immediate economic value in fields of agriculture, life sciences, small and medium agro-enterprises, green technology and rural enterprises. It may functions as a liaison or a catalyst in achieving its above objectives including selective seed funding as well as sourcing of funds for above activities. CARES may also under take proto-type research to develop evidence-based knowledge. </td> </tr>
    <tr>
    
    <td>4.</td> <td>The CARES is funded through subscriptions of members, donation and endowment from individuals, private and public institutions.</td> </tr>
		</table>
        <!--<p class="member">
