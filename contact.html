...
<div id="news">
	...
	<div class="news wide ">
		...
		<div class="doubleFramed large alignleft">
				...
				<img width="283" height="237" src="wp-content/uploads/sites/5/2012/10/contact.jpg" class="attachment-dfl wp-post-image" alt="contact" title="" />		
		</div>
		
	        
        <div  class="right" >
            <h3 style="margin:0; padding:0;">Engr. Md. Abdul Majeed</h3>
            <h5 style="margin:0; padding:0;">Programme Development & Management Consultant </h5>
            
			<p style="color:#000">
            	<b>Address</b> : Suite 4B, Ploat 9, Road 2/1 <br/>
            	Banani, Dhaka 1213 <br/>
                Bangladesh. <br/>
                <b>Phone</b> : 9894033; 01766144966 <br/>
                <b>Email</b> : <a href='mailto:info@caresbd.org'>info@caresbd.org</a>, <a href="mailto:mjd.ma48@gmail.com">mjd.ma48@gmail.com</a>
            </p>
